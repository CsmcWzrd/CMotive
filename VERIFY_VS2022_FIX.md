...
Historical note: this report applies to the former C-fronted 0.2.4 build. The
same collision fixes were carried into the stage-0 seed and self-hosted source.
The active build is documented in `docs/SELF_HOSTING.md` and
`docs/VS2022_PACKAGES.md`.
