// Package/plugin discovery and loading model used by the CMotive frontend.
//
// Plugin Foo::Bar resolves to Foo/Bar.HMOT, Foo/Bar.HMTV, Foo/Bar.CMOT, or
// Foo/Bar.CMTV, and also to Foo/Bar/package.<ext>. The self-hosted frontend
// materializes the package into the current translation unit before parsing.
#include <filesystem>
#include <optional>
#include <string>
#include <vector>
